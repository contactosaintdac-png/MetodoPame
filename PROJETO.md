...
- **Proteção de Endereço com Liberação 24h Antes** — Implementação de lógica temporal no Dashboard da Especialista (`EspecialistaDashboard.tsx`) que oculta o endereço completo do cliente até 24 horas antes do atendimento agendado. Antes disso, a especialista vê apenas um ícone de cadeado com contagem regressiva (ex: "Disponível em 3d 12h"). A política de privacidade (`App.tsx`) foi atualizada para refletir esta medida de segurança de dados.

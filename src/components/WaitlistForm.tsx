    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 py-16 bg-[#fff7fd]" style={{ fontFamily: 'Manrope, sans-serif' }}>
        <motion.div
          ...
          className="w-full max-w-md bg-white rounded-3xl border border-[#efe5ee] shadow-[0_8px_32px_rgba(86,22,104,0.08)] p-8 flex flex-col items-center text-center gap-6"
        >
          <div className="w-16 h-16 bg-[#faf1fa] border border-[#efe5ee] rounded-full flex items-center justify-center text-[#561668] shadow-sm">
          ...
          <div>
            <h2 className="text-2xl font-extrabold text-[#561668] tracking-tight">Cadastro Confirmado!</h2>
            <p className="text-[10px] font-bold uppercase tracking-widest text-[#80737f] mt-1">Método Pame · Lista de Espera</p>
          </div>

          <div className="bg-[#faf1fa] p-5 rounded-2xl border border-[#efe5ee] w-full text-left flex flex-col gap-3">
            <p className="text-xs font-bold text-[#561668]">O que acontece agora?</p>
            <p className="text-[12px] text-[#4e434e] leading-relaxed">
            ...
            {referrerName && (
              <div className="mt-2 p-3 bg-white rounded-xl border border-[#efe5ee] flex gap-2 items-center">
                <span className="material-symbols-outlined text-amber-500 text-base" style={{ fontVariationSettings: "'FILL' 1" }}>stars</span>
                <p className="text-[11px] text-[#561668] font-bold">Indicação de {referrerName} registrada com prioridade.</p>
              </div>
            )}
          </div>
          ...
          <div className="w-full flex flex-col gap-2">
            <button
              ...
              className="w-full h-12 bg-[#561668] hover:bg-[#703081] text-white text-xs font-extrabold uppercase tracking-widest rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95 cursor-pointer shadow-md"
            >
            ...
            <button
              ...
              className="w-full h-12 border border-[#561668]/30 text-[#561668] text-xs font-extrabold uppercase tracking-widest rounded-xl hover:bg-[#faf1fa] transition-all active:scale-95 cursor-pointer"
            >
              Voltar ao Início
            </button>
          </div>
